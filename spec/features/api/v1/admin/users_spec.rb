RSpec.describe Api::V1::Admin::UsersController, type: :controller do
  ...
  it 'should update with valid token' do
    put :update, params: {id: @user_1.id, rest_token: @admin.rest_token, first_name: 'New Firstname', last_name: 'New Lastname',
  ...
  it 'should not update with non-admin token' do
    put :update, params: {id: @user_1.id, rest_token: @user_2.rest_token, first_name: 'New Firstname', last_name: 'New Lastname',
  ...
  it 'should show any user' do
    get 'show', params: {id: @user_1.id, rest_token: @admin.rest_token}

    expect(json['status']).to eq 200
    expect(json['first_name']).to eq @user_1.first_name
    expect(json['last_name']).to eq @user_1.last_name
    expect(json['email']).to eq @user_1.email
    expect(json['role']).to eq @user_1.role
  end


  it 'should reset password' do
    post 'reset_password', params: {id: @user_1.id, email: @user_1.email, rest_token: @admin.rest_token}
    @user_1.reload
  ...
  it 'should destroy user' do
    delete 'destroy', params: {id: @user_1.id, rest_token: @admin.rest_token}
  ...
  it 'should list users' do
    get 'index', params: {rest_token: @admin.rest_token}
  ...
  it 'should sort users' do
    ...
    get 'index', params: {rest_token: @admin.rest_token, sort_field_name: 'first_name', sort_order: 'desc'}
  ...
  it 'should filter users' do
    ...
    get 'index', params: {rest_token: @admin.rest_token, search_phrase: 'AAAAAA'}
    expect(json['result']['users'].map{|u| u['id']}).to eq [@user_1.id]
  end

  it 'should paginate users' do
    get 'index', params: {rest_token: @admin.rest_token, page: 1, per_page: 1}
    expect(json['result']['users'].count).to eq 1
    expect(json['result']['pagination']['total_pages']).to eq 3
  end
end